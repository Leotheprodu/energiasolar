            ...
            <div className=" mx-6 xl:mx-[20rem] mt-10">
                ...
                <div className="mt-[10rem] flex flex-col gap-5">
                    <p>
                        ...
                        energéticas en Colombia. Nos especializamos en
                        instalación y ejecución de proyectos solares, ofreciendo
                        servicios On Grid, Off Grid y sistemas híbridos. Nuestra
                        experiencia garantiza resultados de calidad y
                        eficiencia, respaldados por un mantenimiento continuo
                        que asegura el máximo rendimiento a lo largo del tiempo.
                    </p>

                    <p>
                        Descubre cómo DC Energía Solar puede transformar tu
                        empresa con soluciones solares de vanguardia.
                        Contáctanos para una consulta personalizada y comienza
                        tu viaje hacia la independencia energética y la
                        sostenibilidad. Juntos, estamos creando un mañana más
